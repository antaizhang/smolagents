"""B0-B3 baseline configurations used for SensitiveGuard comparisons."""
    ...
    def __post_init__(self) -> None:
        if not isinstance(self.baseline, Baseline):
            try:
                ...
                raise ValueError("BaselineConfig.baseline must be B0, B1, B2, or B3") from None
...
BASELINES = MappingProxyType(
    {
        ...
        Baseline.B2: BaselineConfig(
            ...
            display_name="GLiNER plus redaction",
        ...
        Baseline.B3: BaselineConfig(
            ...
            display_name="Full SensitiveGuard",
            description="The complete context-aware privacy runtime and enforcement boundary.",
            detection=True,
            uniform_redaction=False,
